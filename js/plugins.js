            ...
            t.create = function(e, n) {
                var t = function(e, n) {
                    ...
                    var c = r(i, "IMG")
                      , u = r(i, "VIDEO")
                      , s = r(i, "IFRAME");
                    return !0 === c && t.classList.add("basicLightbox--img"),
...
!function(t) {
    ...
    r.buttonIcon2 = l,
    r.buttonIcon3 = l,
    r.buttonIcon4 = '<svg viewBox="0 0 24 24"><g class="nc-icon-wrapper" stroke-linecap="square" stroke-linejoin="miter" stroke-width="2" fill="currentColor" stroke="currentColor"><line data-color="color-2" fill="none" stroke-miterlimit="10" x1="5" y1="6" x2="6" y2="6"/> <line data-color="color-2" fill="none" stroke-miterlimit="10" x1="10" y1="6" x2="11" y2="6"/> <line data-color="color-2" fill="none" stroke-miterlimit="10" x1="15" y1="6" x2="19" y2="6"/> <line fill="none" stroke="currentColor" stroke-miterlimit="10" x1="1" y1="10" x2="23" y2="10"/> <rect x="1" y="2" fill="none" stroke="currentColor" stroke-miterlimit="10" width="22" height="20"/></g></svg>',
    r.buttonIconCopy = a,
    ...
    t.buildStyleTag = function() {
        ...
        return e = e.replace(/mailtoui/g, t.prefix()),
    ...
    t.getModal = function(o) {
        return t.hydrateModal(o),
        document.getElementById(t.prefix("-modal"))
    }
    ,
    t.hydrateModal = function(o) {
        ...
        document.getElementById(t.prefix("-button-1")).href = "https://mail.google.com/mail/?view=cm&fs=1&to=" + e + "&su=" + i + "&cc=" + n + "&bcc=" + l + "&body=" + a,
        document.getElementById(t.prefix("-button-2")).href = "https://outlook.office.com/owa/?path=/mail/action/compose&to=" + e + "&subject=" + i + "&body=" + a,
        document.getElementById(t.prefix("-button-3")).href = "https://compose.mail.yahoo.com/?to=" + e + "&subject=" + i + "&cc=" + n + "&bcc=" + l + "&body=" + a,
        document.getElementById(t.prefix("-button-4")).href = "mailto:" + e + "?subject=" + i + "&cc=" + n + "&bcc=" + l + "&body=" + a,
        document.getElementById(t.prefix("-email-address")).innerHTML = e,
        document.getElementById(t.prefix("-button-icon-1")).innerHTML = r.buttonIcon1,
        document.getElementById(t.prefix("-button-icon-2")).innerHTML = r.buttonIcon2,
        document.getElementById(t.prefix("-button-icon-3")).innerHTML = r.buttonIcon3,
        document.getElementById(t.prefix("-button-icon-4")).innerHTML = r.buttonIcon4,
        document.getElementById(t.prefix("-button-icon-copy")).innerHTML = r.buttonIconCopy,
    ...
    t.openModal = function(o) {
        r.disableOnMobile && t.isMobileDevice() || (o.preventDefault(),
    ...
    t.modalFocus = function() {
        i.focusableChildren = Array.from(i.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])')),
    ...
    t.enablePageScrolling = function(i) {
        i ? (e.classList.remove(t.prefix("-no-scroll")),
        o.classList.remove(t.prefix("-no-scroll"))) : (e.classList.add(t.prefix("-no-scroll")),
    ...
    t.getParentElement = function(t, o) {
        for (; null !== t; ) {
            if (t.tagName.toUpperCase() == o.toUpperCase())
                return t;
            t = t.parentNode
        }
        return null
    ...
    t.listenForClickOnLink = function() {
        for (var o = document.getElementsByClassName(t.prefix()), e = 0; e < o.length; e++)
            o[e].addEventListener("click", function(o) {
                t.openModal(o)
            }, !1)
    }
    ,
    t.listenForClickOnClient = function() {
        for (var o = document.getElementsByClassName(t.prefix("-button")), e = 0; e < o.length; e++)
            o[e].addEventListener("click", function(o) {
                o.preventDefault(),
                o.stopPropagation();
                var e = t.getParentElement(o.target, "a");
    ...
    t.trapTabWithinModal = function(t) {
        if (9 === t.keyCode && null !== i) {
            ...
            t.shiftKey ? 0 === n && (t.preventDefault(),
            i.focusableChildren[e - 1].focus()) : n == e - 1 && (t.preventDefault(),
    ...
    t.splitLink = function(t) {
        var o = t.href.replace("mailto:", "").trim()
          , e = o.split("?", 1);
        return null !== e && e.length > 0 && (e[1] = o.replace(e[0] + "?", "").trim()),
        e
    }
    ,
    t.getLinkField = function(o, e) {
        ...
        null !== n && n.length > 0 && (l = (n = n.replace("%20&%20", "%20%26%20")).split("&"));
        for (var r = 0; r < l.length; r++) {
            l[r] = l[r].replace("%20=%20", "%20%3D%20"),
            a = l[r].split("=");
    ...
    t.getEmail = function(o) {
        var e = t.splitLink(o)
          , i = "";
        return null !== e && e.length > 0 && (i = e[0]),
...
"undefined" != typeof module && void 0 !== module.exports ? module.exports = {
    run: mailtouiApp.run
} : mailtouiApp.run();
    ...
    t.prototype.move = function(i) {
        ...
        if (0 === i || i) {
            ...
            window.requestAnimationFrame(function t(n) {
                ...
                o < c.duration ? window.requestAnimationFrame(t) : (c.container.scroll(0, s + f),
                c.callback(i))
            })
        }
    }
